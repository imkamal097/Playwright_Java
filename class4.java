...
public class class4 {
  ...
  public void testNavigateToDepartmentSection() {
      page.locator("[ng-reflect-value='department']").click();
      page.locator("button:has-text('Continue')").click();
  }


  @Test(priority = 4, dependsOnMethods = "testNavigateToDepartmentSection")
  public void testAddDepartmentDetails() {
    page.locator("#Dept_Id").click();
    page.locator("#Dept_Name").click();
    page.locator("button:has-text('Add Screen')").click();
    page.locator("//input[@type='text']").fill("CRO");
    page.locator("button:has-text('Submit')").click();
  }

  @Test(priority = 5, dependsOnMethods = "testAddDepartmentDetails")
