...
public class class3 {
  ...
  public void testNavigateToRoleSection() {
    page.locator("[ng-reflect-value='role']").click();
    page.locator("button:has-text('Continue')").click();
  }

  @Test(priority = 4, dependsOnMethods = "testNavigateToRoleSection")
  public void testAddRoleDetails() {
  ...
  @Test(priority = 5, dependsOnMethods = "testAddRoleDetails")
  ...
  @Test(priority = 6, dependsOnMethods = "testReturnToMainScreenAndSetLimit")
